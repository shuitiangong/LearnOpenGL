...
int main(int argc, char *argv[]) {
    ...
    for (int i = 0; i<4; ++i) {
        ...
        value_name += i+'0';
        lightingShader.setFloat(value_name + "].constant", 1.0f);
        lightingShader.setFloat(value_name + "].linear", 0.09f);
        lightingShader.setFloat(value_name + "].quadratic", 0.032f);
        lightingShader.setVec3(value_name + "].ambient", 0.1f, 0.1f, 0.1f);
        lightingShader.setVec3(value_name + "].diffuse", 0.8f, 0.8f, 0.8f);
    ...
    Model ourModel = Model("./static/model/nanosuit/nanosuit.obj");
