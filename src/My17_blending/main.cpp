...
int main(int argc, char *argv[]) {
    ...
    unsigned int grassTesture = loadTexture("./static/texture/blending_transparent_window.png");
    ...
    sort(vegetation.begin(), vegetation.end(), [](glm::vec3 v1, glm::vec3 v2) {return v1.z < v2.z;});
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // grass
        glBindVertexArray(vegetationVAO);
        glBindTexture(GL_TEXTURE_2D, grassTesture);
